...
```
    <dependency>
      ...
      <artifactId>shellbase-core_2.12</artifactId>
      <version>1.5.3</version>
    </dependency>

    <dependency>
      <groupId>com.sumologic.shellbase</groupId>
      <artifactId>shellbase-slack_2.12</artifactId>
      <version>1.5.3</version>
    </dependency>
```
...
3. Make a release branch with Scala version and project version, ex. `shellbase-1.5.4`:
    ```
    export RELEASE_VERSION=shellbase-1.5.4
